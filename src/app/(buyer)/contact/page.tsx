...
export const metadata: Metadata = {
  ...
  description: "Liên hệ đội ngũ hỗ trợ CommerceHub để được giải đáp và hỗ trợ tài khoản.",
};
...
const contactItems: Array<{
  ...
  },
  {
    icon: Send,
    title: "Telegram",
    lines: ["@commercehub_support", "Thông tin minh họa"],
  },
  {
    icon: Phone,
    title: "Hotline",
    lines: ["0900 000 000", "Số điện thoại minh họa"],
  },
  {
    icon: Mail,
    title: "Email",
      ...
      <div className="mx-auto max-w-[1200px] px-4 py-8 sm:px-6 sm:py-10 lg:py-12">
        ...
        <div className="mt-5 max-w-2xl">
          ...
          <p className="mt-3 text-sm leading-6 text-slate-600 sm:text-base">
            Đội ngũ CommerceHub sẽ cố gắng tiếp nhận và giải quyết thắc mắc của bạn nhanh nhất có thể.
          </p>
        </div>
        ...
        <div className="mt-8 grid items-start gap-6 lg:grid-cols-[minmax(0,1.08fr)_minmax(340px,0.92fr)]">
          ...
          <aside className="space-y-5">
            <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="mt-0.5 text-xs text-slate-500">Dữ liệu minh họa cho giao diện</p>
                </div>
              </div>
              ...
              <div className="mt-6 grid gap-5 sm:grid-cols-2 lg:grid-cols-1">
                {contactItems.map(({ icon: Icon, title, lines }) => (
                  <div key={title} className="flex items-start gap-3">
                    <span className="mt-0.5 grid size-8 shrink-0 place-items-center rounded-lg bg-slate-50 text-emerald-700">
            ...
            <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
              <h2 className="font-bold text-slate-950">Kết nối với chúng tôi</h2>
            ...
            <section className="overflow-hidden rounded-2xl border border-emerald-200 bg-emerald-50 p-6 text-center">
              ...
              <h2 className="mt-4 text-lg font-bold text-emerald-900">Hỗ trợ nhanh chóng</h2>
              <p className="mt-2 text-sm leading-6 text-emerald-800/70">
                Đội ngũ hỗ trợ luôn sẵn sàng đồng hành cùng bạn trong khung giờ làm việc.
              </p>
            </section>
          </aside>
        </div>
