...
export interface AdminWithdrawal { id:number; userId:number; username:string|null; email:string; amount:number; fee:number; bankName:string; accountNumber:string; accountName:string; status:string; adminNote:string|null; processorUsername:string|null; processedAt:string|null; createdAt:string }
